...
class TheWikipediaLibraryHooksTest extends MediaWikiIntegrationTestCase {
	...
	/**
	 * @covers \TheWikipediaLibraryHooks::onPageContentSaveComplete()
	 */
	public function testOnPageContentSaveCompleteUserNotified() {
		$flags = EDIT_NEW;
		$prefsFactory = $this->getMockBuilder( GlobalPreferencesFactory::class )
				->disableOriginalConstructor()
				->setMethods( [ 'getGlobalPreferencesValues' ] )
		...
		TheWikipediaLibraryHooks::onPageContentSaveComplete(
			...
			null,
			$flags,
			$this->createMock( Revision::class ),
	 ...
	 * @covers \TheWikipediaLibraryHooks::onPageContentSaveComplete()
	 */
	public function testOnPageContentSaveCompleteUserNotNotified() {
		$flags = EDIT_NEW;
		$prefsFactory = $this->getMockBuilder( GlobalPreferencesFactory::class )
				->disableOriginalConstructor()
				->setMethods( [ 'getGlobalPreferencesValues' ] )
